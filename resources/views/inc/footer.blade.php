<div class="md:bg-gray-700 p-8 bg-gray-100">
  ...
  <div class="sm:w-1/4 h-auto md:text-white">
      <div class="text-red-500 font-black mb-2">Orange</div>
  ...
  <div class="md:text-white sm:w-1/4 h-auto sm:mt-0 mt-8">
    ...
    <div class="text-red-500 font-black  mb-2 mt-4">Blue-light</div>
      <ul class="list-reset leading-normal">
  ...
  <div class="md:text-white sm:w-1/4 h-auto sm:mt-0 mt-8">
            <div class="text-red-500 font-black  mb-2">Green-dark</div>
      <ul class="list-reset leading-normal">
    ...
    <div class="md:text-red-500 font-black  mb-2 mt-4">Green-light</div>
      <ul class="list-reset leading-normal">
